...
xread = xlrd.open_workbook('D://software//JetBrains//Toolbox//apps//PyCharm-P//pythonProject//BertPytorch//utils//function.xls')
keywords_4 = []
...
typewords_0 = ('short', 'int', 'long', 'float', 'double', 'char', 'unsigned', 'signed', 'void', 'wchar_t', 'size_t', 'bool')
                        ...
                        if token[j] in _func_dict.keys():
                            ...
                            if len(list_values) == 0:
                                ...
                                if token[j] in _func_dict.keys():
                                    ...
                                    _max = max(list_num)
                                    _func_dict[token[j]] = 'function_' + str(_max+1)
                                    token[j] = _func_dict[token[j]]
                            j = j + 2
